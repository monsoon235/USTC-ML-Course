...
if __name__ == "__main__":
    ...
    # choose better model
    delta1 = ((yhat1 - y) ** 2).sum()
    delta2 = ((yhat2 - y) ** 2).sum()
    print('total delta of linear regression:', delta1)
    print('total delta of quadratic regression:', delta2)
    print()
    delta = delta1 - delta2
    if delta < -1e-10:
